...
Most of analysis will be made by country. As it was already said something about the total jobs available by country, check again [TDESC02](/out/TDESC02.html) to check the counts of jobs available and [LDESC02](/out/LDESC02.html) to see any of the statistics. 
